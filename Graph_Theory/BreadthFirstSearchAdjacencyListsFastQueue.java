// Problem Statement : 
// Implementing iterative BFS with an adjacency list
// Time Complexity ; O(V+E) { V for vertices, E for Edges}
package Graph_Theory;
public class BreadthFirstSearchAdjacencyListsFastQueue
{
    
    // Inorder to improve on efficiency we construct our own circular queue w
    // In terms of performance it can outperform java.util.ArrayDeque by a factor of 40+
    // But we need to know an upper bound on the number of elements that will be inside the queue
    // at any given time for the queue to work
    class IntQueue
    {
